...
set solution_dir "/home/rnarayan/hls4ml/thea/Quantized_CNN/cnn_projects/full_10bit_reuse1/myproject_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {myproject_mux_255_9_1_1
fifo_w16_d84_A
fifo_w16_d84_A
fifo_w16_d84_A
fifo_w16_d84_A
...
set Interfaces {
    ...
    layer13_out_V_data_0_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer13_out_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    layer13_out_V_data_1_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer13_out_V_data_1_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    ap_clk {
        ...
        buses "conv2d_input_V_data_0_V layer13_out_V_data_0_V layer13_out_V_data_1_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 937 II x}
