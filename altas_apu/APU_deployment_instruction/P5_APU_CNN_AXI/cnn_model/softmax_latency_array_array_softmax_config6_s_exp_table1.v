...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module softmax_latency_array_array_softmax_config6_s_exp_table1_rom (
...
initial begin
    $readmemh("./softmax_latency_array_array_softmax_config6_s_exp_table1_rom.dat", ram0);
    $readmemh("./softmax_latency_array_array_softmax_config6_s_exp_table1_rom.dat", ram1);
    $readmemh("./softmax_latency_array_array_softmax_config6_s_exp_table1_rom.dat", ram2);
    $readmemh("./softmax_latency_array_array_softmax_config6_s_exp_table1_rom.dat", ram3);
    $readmemh("./softmax_latency_array_array_softmax_config6_s_exp_table1_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module softmax_latency_array_array_softmax_config6_s_exp_table1(
    reset,
    clk,
    address0,
    ce0,
...
softmax_latency_array_array_softmax_config6_s_exp_table1_rom softmax_latency_array_array_softmax_config6_s_exp_table1_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
